...
#from google.appengine.ext import ndb #python 2.7
#import jinja2
from google.cloud import ndb

from mako.template import Template
mytemplate = Template("Hello mainBaseline.py World!")
print(mytemplate.render())

exit(0)
#import Jinja2
import webapp2
TODO: change out webapp2
TODO: Use Flask instead of JINJA
...
class GetTicker():
    ...
    def getShareInfo(self, ticker):
        ...
        if self.valid == 1:
            ...
            #r = urllib2.urlopen(urlFullPath) # Python 2.5
            r = urllib.request.urlopen(urlFullPath) # Python 3.7
            c = r.read()
            d = c.split('"c"')
            logging.info("|| d")
            logging.info(d)
    ...
    def post(self):
        ...
        if (removeCheck == "View"):
            ...
            if(tickerToAdd):
                ...
                #if(at.valid <> 1): # Invalid symbol; Return # python 2.7
                if(at.valid != 1): # Invalid symbol; Return # python 3.7
